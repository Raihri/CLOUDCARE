...
public class admin_controller {
    ...
    public String approveDoctor(@RequestParam Long doctorId) {
        doctorService.approveDoctor(doctorId.intValue());
    ...
    doctorService.rejectDoctor(doctorId.intValue(), reason); // <-- email is sent here
    doctorService.deleteDoctor(doctorId.intValue()); // <-- doctor is deleted here
    return "redirect:/admin/pending-doctors";
}
}
